...
import { Download, Loader2, Save, UploadCloud, KeyRound, ArrowLeft } from 'lucide-react';
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Importe, processe e exporte seus dados de planilha.
          </p>
        </div>
      </div>
       ...
       <div className="mx-auto max-w-4xl">
        {isAuthenticated ? (
            ...
            <Card>
                <CardHeader>
                    <CardTitle className="flex items-center gap-2"><KeyRound /> Acesso Restrito ao Painel</CardTitle>
                    <CardDescription>Por favor, insira a senha para acessar o painel de administrador.</CardDescription>
                </CardHeader>
                <CardContent>
